package tw.noel.sung.com.structure_viewpagerwithdrawerlayout.util.toolbox.adapter;
...
public class ToolBoxAdapter extends RecyclerView.Adapter<ToolBoxAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(ToolBoxAdapter.ViewHolder holder, int position) {

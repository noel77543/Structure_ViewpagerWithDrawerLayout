package tw.noel.sung.com.structure_viewpagerwithdrawerlayout.video.funnay.adapter;
...
public class FunnyAdapter extends RecyclerView.Adapter<FunnyAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(FunnyAdapter.ViewHolder holder, int position) {
